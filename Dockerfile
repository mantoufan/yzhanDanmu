...
RUN git clone https://github.com/mhjlw/OpenCV-for-PHP.git && mv OpenCV-for-PHP o 
RUN cd o && phpize && ./configure && make && ln /dev/null /dev/raw1394 && make test
...
RUN wget https://raw.githubusercontent.com/mhjlw/up/master/log.php
